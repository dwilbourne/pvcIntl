 ...
 *
 * These are valid language codes according to the ISO spec.  This class implements validator interface
 * but it does not declare that because adding the entire validator package seems like overkill in order
